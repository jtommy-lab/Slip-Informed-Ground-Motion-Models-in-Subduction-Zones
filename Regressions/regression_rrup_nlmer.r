...
###############################################
'Script to perform mixed effects regression for Rrup-based GMM'
...
if (regional_flag == TRUE){
    dBe_path = '/home/jtommy/Escritorio/Respaldo/Paper1_v2/residuales/nlmer/dBe_residual_Rrup_regional.csv'
    dWe_path = '/home/jtommy/Escritorio/Respaldo/Paper1_v2/residuales/nlmer/dWe_residual_Rrup_regional.csv'
    stats_path = '/home/jtommy/Escritorio/Respaldo/Paper1_v2/residuales/nlmer/Stats_residual_Rrup_regional.csv'
    coef_Rrup_path = '/home/jtommy/Escritorio/Respaldo/Paper1_v2/Regresiones/Rrup/nlmer/coeficientes_Rrup_nlmer_regional.csv'
} else {
    dBe_path = '/home/jtommy/Escritorio/Respaldo/Paper1_v2/residuales/nlmer/dBe_residual_Rrup.csv'
    dWe_path = '/home/jtommy/Escritorio/Respaldo/Paper1_v2/residuales/nlmer/dWe_residual_Rrup.csv'
    stats_path = '/home/jtommy/Escritorio/Respaldo/Paper1_v2/residuales/nlmer/Stats_residual_Rrup.csv'
    coef_Rrup_path = '/home/jtommy/Escritorio/Respaldo/Paper1_v2/Regresiones/Rrup/nlmer/coeficientes_Rrup_nlmer.csv'
...
for (i in seq_along(Periods)){
    ...
    print(paste0('Intensity measure = ',obs_colname))
